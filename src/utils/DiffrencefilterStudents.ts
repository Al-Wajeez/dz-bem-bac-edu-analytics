import type { Student } from '../components/tcs/DiffrenceAnalysis';
import { FilterState } from '../lib/DiffrencefilterStore';
...
export function filterStudents(students: Student[], filters: FilterState): Student[] {
  return students.filter((student) => {
    ...
    if (filters.subjectTermA.length === 1 && filters.subject.length) {
