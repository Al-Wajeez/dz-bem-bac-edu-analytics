...
const printAllTablesByClass = (tableClass = 'printable-table', titleClass = 'table-title', students: Student[] = []) => {
  ...
  const firstContent = `
        <table border="0" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
          ...
          <tr>
            <td colspan="2" style="text-align: center; border: 2px solid #ffffff;">
              <p style="font-size: 2rem; font-weight: bold; margin: 4rem 0 0 0;">تحليل نتائج</p><br>
              <p style="font-size: 3.5rem; font-weight: bold; margin: 1rem;">شهادة التعليم المتوسط</p><br>
  ...
  const introContent = `
    <div dir="rtl" style="page-break-before: always; font-family: 'Cairo'; line-height: 1.5; font-size: 18.7px; text-align: justify;">
      <h1 style="text-align: center; margin-bottom: 30px;">تقرير تحليل نتائج شهادة التعليم المتوسط</h1>
      
      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">1. المقدمة</h2>
        <p>
          في إطار المتابعة البيداغوجية المستمرة لمردود تلاميذ السنة الرابعة متوسط، شهدت ${schoolsText} خلال دورة جوان ${currentYear} إجراء امتحانات شهادة التعليم المتوسط في أجواء تنظيمية تربوية محكمة. بلغ عدد المترشحين لاجتياز هذه الشهادة ${totalCount} تلميذًا وتلميذة، وأسفرت النتائج عن نجاح ${PassCount} تلميذًا، مقابل رسوب ${NoPassCount}، بنسبة نجاح بلغت ${PassPercentage} بالمئة. وتندرج هذه المحطة التقييمية ضمن سلسلة الممارسات التربوية الرامية إلى قياس مدى تحقق الكفاءات المستهدفة في نهاية المرحلة المتوسطة، والوقوف على مخرجات العملية التعليمية، بغية تعزيز النجاحات ومعالجة مواطن القصور.
        </p>
        <p>
        وبتحليل النتائج حسب الجنس، نلاحظ أن عدد الناجحين من الذكور بلغ ${mPassCount}، في حين سجلت الإناث ${fPassCount} ناجحة. وتبلغ نسبة النجاح في صفوف الذكور ${mPassPercentage} بالمئة، بينما ${diffrise} هذه النسبة لدى الإناث إلى ${fPassPercentage}. ومن خلال هذه المعطيات، يتضح أن ${diffsuperiority} من حيث عدد الناجحين والنسبة المحققة، وهو ما يعكس ثباتًا في أداء ${diffperformance}، وربما يشير إلى عوامل متعلقة بالمواظبة والانضباط الدراسي.
        </p>
        <p>
        أما من حيث صفة التلميذ (معيد أو غير معيد)، فقد تم تسجيل ${rPassCount} تلميذًا ناجحًا من بين المعيدين، مقابل ${nrPassCount} من بين التلاميذ غير المعيدين. وبلغت نسبة النجاح لدى المعيدين ${rPassPercentage} بالمئة، في حين بلغت نسبة النجاح لدى غير المعيدين ${nrPassPercentage} بالمئة. وبالرجوع إلى المعدلات، نلاحظ أن ${diffrepeatrise} هم الأكثر تفوقًا، مما يبرهن على أن ${diffrepeatperformance}
        </p>
        <P>
        وفي إطار تحليل النتائج حسب الأقسام، أظهرت الدراسة أن القسم  ${highestDepartment} حقق أعلى معدل عام في الشهادة والذي يقدر بـ ${highestMean}، مما يعكس ديناميكية تعليمية خاصة داخله، سواء من حيث أداء التلاميذ أو فاعلية الأستاذ. بالمقابل، سجّل القسم  ${lowestDepartment} أدنى معدل في الشهادة .والذي يساوي ${lowestMean}، وهو ما يدعو إلى التعمق في الأسباب الكامنة وراء هذا التراجع، سواء من حيث مستوى التلاميذ، أو طبيعة التفاعل البيداغوجي، أو الظروف المحيطة.
        </P>
        <p>
        إن هذه المؤشرات الرقمية لا تُقرأ بمعزل عن السياق العام للعمل التربوي داخل المؤسسة، بل يجب أن تُفهم كأداة للتوجيه واتخاذ قرارات بيداغوجية مدروسة، ترمي إلى تعميم النجاحات وتقليص مصادر التعثر، من خلال خطط علاجية، حصص دعم، وتحفيز الفئات المتفوقة. ويُعد هذا التقرير ركيزة لتوجيه السياسات البيداغوجية المقبلة نحو تطوير الأداء العام وتحقيق أهداف الجودة التربوية المنشودة.
        </p>
        <p>
        تُعد شهادة التعليم المتوسط محطة مفصلية في المسار الدراسي للتلميذ، إذ تمثل انتقالًا حاسمًا نحو التعليم الثانوي، وتشكّل في الوقت نفسه مؤشرًا دقيقًا على فاعلية البرامج التعليمية ومدى تكامل الأدوار البيداغوجية داخل المؤسسة. وتكمن أهميتها في كونها ثمرة تراكمات تعليمية وتربوية تمتد على مدى أربع سنوات من التعليم المتوسط، يتم خلالها بناء الكفاءات الأساسية في مختلف المواد، وتطوير المهارات الفكرية والمعرفية والاجتماعية.
        </p>
        <p>
        وفي هذا السياق، تكتسي عملية تحليل نتائج التلاميذ أهمية بالغة، ليس فقط كمؤشر على مدى تحقيق الأهداف التعليمية، وإنما كأداة تشخيصية تسمح بتحديد الفجوات التعلّمية ومواطن القوة، وتوفير الأساس المعرفي لوضع خطط بيداغوجية استدراكية أو تطويرية. كما تساهم هذه العملية في ترسيخ ثقافة التقويم التربوي المبني على معطيات واقعية قابلة للقياس، وتدعم في الوقت نفسه اتخاذ قرارات مدروسة لتحسين جودة التعليم.
        </p>
        <p>
        من جهة أخرى، فإن قراءة النتائج في ضوء الخصوصيات الفردية والجماعية للتلاميذ، وسياقهم الاجتماعي والاقتصادي، يسمح بفهم أعمق للظروف المحيطة بالعملية التعليمية، ويُمكّن من تصميم تدخلات أكثر نجاعة وتوجيها نحو الفئات المستهدفة. وبالتالي، فإن هذا التقرير لا يكتفي بتقديم أرقام ومعدلات، بل يسعى إلى تقديم رؤية تحليلية شاملة، من شأنها أن تكون منطلقًا لجهد جماعي في خدمة النجاح المدرسي والارتقاء بالمردودية العامة للمؤسسة.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">2. الخلفية التحليل</h2>
        <p>
        إن تحليل نتائج شهادة التعليم المتوسط ليس مجرّد إجراء تقني، بل هو ممارسة تربوية تهدف إلى فهم أعمق لأداء المؤسسة وتلاميذها. في ظل التغيرات المتسارعة في الحقل التربوي، وازدياد التحديات التي تواجه المنظومة التعليمية، أصبح من الضروري اعتماد آليات علمية لتشخيص الوضع التربوي، تسمح بصياغة خطط تطويرية واقعية. إن النتائج التي يحققها التلاميذ في نهاية كل مرحلة تمثل انعكاسًا مباشرًا للجهود المبذولة طيلة سنوات الدراسة، سواء من طرف الهيئة التربوية أو الإدارية أو التلميذ نفسه، وتستلزم وقفة تأمل وتحليل دقيق.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">3. أهداف التحليل</h2>
        <p>
        يهدف هذا التقرير إلى تقديم قراءة نقدية وعلمية لنتائج التلاميذ، من خلال تشخيص مدى تحقق الكفاءات في مختلف المواد، ورصد نقاط القوة والضعف، مع إبراز الفروقات الفردية والجماعية على مستوى الأداء. كما يرمي إلى وضع أسس عملية لبناء تدخلات بيداغوجية فعّالة في المستقبل، من شأنها تحسين نوعية التعليم والرفع من مردودية التعلّم. ويساعد هذا العمل على تمكين الطاقم التربوي من تصور شامل حول مستوى التحصيل الدراسي، وتوجيه جهود الدعم والمرافقة نحو الفئات المستهدفة.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;page-break-before: always;">4. أهمية التحليل البيداغوجي</h2>
        <p>
        يمثل التحليل التربوي للنتائج أداة مركزية في ضبط الأداء التربوي للمؤسسة وتقييم مدى نجاعة البرامج والأساليب المعتمدة. تتجلى أهمية هذه الممارسة في ما توفره من معطيات دقيقة تسهم في فهم سياقات النجاح والإخفاق، كما تتيح فرصة لتوجيه الجهود بشكل علمي ومنهجي نحو تحسين المخرجات. إن اعتماد مؤشرات واضحة للتحصيل يسمح بتوجيه القرارات الإدارية والتربوية على أساس واقعي، ويعزز ثقافة التقويم المستمر كأحد أعمدة العمل التربوي الفعّال.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">5. منهجية التحليل</h2>
        <p>
        ارتكز هذا التقرير على تحليل كمي ونوعي للنتائج المحصل عليها، حيث تم تصنيف المعطيات حسب المواد، الفئات، والأقسام، مع اعتماد أدوات إحصائية بسيطة تساعد في استقراء المؤشرات العامة. كما تم الأخذ بعين الاعتبار الخصوصيات البيداغوجية للمؤسسة، والتركيز على الفروقات الفردية التي تُبرز الحاجة إلى تدخلات مخصصة. وتم دعم هذا التحليل بملاحظات مستخلصة من الممارسة اليومية للأساتذة، والملاحظات المسجلة خلال الفصول الدراسية، ما أضفى على التقرير بعدًا تشخيصيًا شاملًا.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">6. عرض النتائج العامة</h2>
        <p>
        أظهرت نتائج هذه الدورة تفاوتًا في الأداء العام بين التلاميذ، حيث تراوحت المعدلات بين [أدنى معدل] و[أعلى معدل]، بمعدل عام للمؤسسة بلغ [xx,x/20]. هذا المؤشر يعكس مستوى التحصيل الإجمالي، ويشكّل قاعدة أساسية لمقارنة الأداء الفردي والجماعي. كما يُبرز نسبة النجاح المحققة حجم الجهود المبذولة طيلة السنة، ويستدعي قراءة معمّقة للعوامل المؤثرة على النتائج.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;page-break-before: always;">7. التحليل حسب المواد</h2>
        <p>
        أفرزت نتائج الامتحانات تفاوتًا واضحًا بين المواد، إذ برزت بعض المواد كمجالات قوية تحقق فيها التلاميذ نسب نجاح مرتفعة، بينما سجلت أخرى أداءً دون المتوسط. يُلاحظ أن المواد العلمية عمومًا (كالرياضيات والعلوم الفيزيائية) حققت نتائج مرضية في بعض الأقسام، بينما لوحظ ضعف في التحكم بالمهارات اللغوية في مواد مثل اللغة الفرنسية. يستدعي هذا التفاوت فحصًا دقيقًا لطبيعة الأسئلة، ومدى ارتباطها بالمحتوى المُدرّس، ومدى تحكم التلاميذ في المنهج.
        </p>
      </div>

      <div class="intro-section">
        <h2 style="color: #2d3748; border-bottom: 2px solid #ddd; padding-bottom: 8px;">8. التحليل النوعي</h2>
        <p style=" page-break-after: always;">
        أسفر التحليل النوعي عن معطيات دقيقة أبرزت تميز عدد من التلاميذ في مواد معينة، مقابل صعوبات لدى البعض الآخر، لا سيما في الفهم والاستيعاب. كما كشفت النتائج عن تفوق نسبي للإناث في مواد اللغات، مقابل أداء أفضل للذكور في المواد التقنية والعلمية. من جهة أخرى، سجلت بعض الأقسام معدلات جماعية أعلى، مما يدل على أثر العوامل الجماعية كالتنظيم، الانضباط، والتفاعل الصفي. هذا التحليل النوعي يوفر منظورًا أعمق يسمح بفهم السياقات التعليمية بشكل شامل.
        </p>
      </div>
    </div>
  `;
...
function enrichStudentsWithDecisionAndProfile(students: Student[]): Student[] {
  ...
  return students.map(student => {
    ...
    // Decision logic
    const birthDateStr = student['تاريخ الميلاد'];
    ...
    let decision = '';
    if (age < 16) {
      decision = transferGrade >= 10 ? 'ينتقل إلى قسم أعلى' : 'يعيد السنة';
    } else {
      decision = transferGrade >= 10 ? 'ينتقل إلى قسم أعلى' : 'يوجه إلى التكوين المهني';
    }
...
//#region Custom hooks
const useSubjectStats = (data: Student[]) => {
  return useMemo(() => {
    const subjects = [
      'العربية ش ت م', 'الأمازيغية ش ت م', 'الفرنسية ش ت م', 'الإنجليزية ش ت م', 'ت إسلامية ش ت م',
      'ت مدنية ش ت م', 'تاريخ جغرافيا ش ت م', 'رياضيات ش ت م', 'علوم ط ش ت م', 'فيزياء ش ت م', 'معلوماتية ش ت م',
      'ت تشكيلية ش ت م', 'ت موسيقية ش ت م', 'ت بدنية ش ت م', 'المعدل السنوي', 'معدل ش ت م', 'معدل الإنتقال'
    ];
...
const useGradeDistribution = (data: Student[]) => {
  return useMemo(() => {
    const subjects = [
      'العربية ش ت م', 'الأمازيغية ش ت م', 'الفرنسية ش ت م', 'الإنجليزية ش ت م', 'ت إسلامية ش ت م',
      'ت مدنية ش ت م', 'تاريخ جغرافيا ش ت م', 'رياضيات ش ت م', 'علوم ط ش ت م', 'فيزياء ش ت م', 'معلوماتية ش ت م',
...
const useGenderStats = (data: Student[]) => {
  return useMemo(() => {
...
const useRepeatStats = (data: Student[]) => {
  return useMemo(() => {
...
//--------------------------------------------------------------------------
// تحليل نتائج الشهادة التعليم المتوسط
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='subjecttitle' className="text-xl font-semibold">تحليل نتائج الشهادة التعليم المتوسط</h2>
      ...
      {showChart && (
        <SubjectStatsChart
          stats={stats}
          title="تحليل نتائج الشهادة التعليم المتوسط حسب المواد"
...
//--------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب الفئات
const GradeDistributionTable: React.FC<{ distribution: GradeDistribution[]; isDarkMode: boolean }> = ({ distribution, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='gradeDistributiontitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب الفئات</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
      ...
      {showChart && (
        <GradeDistributionChart
          ...
          title='تحليل نتائج الشهادة حسب الفئات'
          isDarkMode={isDarkMode}
          onClose={() => setShowChart(false)}
        />
      )}
...
//--------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب نسبة النجاح
...
const GenderDifferenceTable: React.FC<{ differences: GenderDifferenceStats[]; isDarkMode: boolean }> = ({ differences, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='genderDifferencetitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب الجنس</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//--------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب الإعادة
...
//---------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب حصيلة المعدلات
const DetailedGradeDistributionTable: React.FC<{ distribution: DetailedGradeDistribution[]; isDarkMode: boolean }> = ({ distribution, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='detailedGradeDistributiontitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب حصيلة المعدلات</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//---------------------------------------------------------------------------
//تحليل نتائج الشهادة حسب نسبة الإنسجام
const HarmonyStatsTable: React.FC<{ stats: HarmonyStats[]; isDarkMode: boolean }> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='harmonyStatstitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب نسبة الإنسجام</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//---------------------------------------------------------------------------
//تحليل نتائج الشهادة حسب الفئات الخمس
const CategoryStatsTable: React.FC<{ stats: CategoryStats[]; isDarkMode: boolean }> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='categoryStatstitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب الفئات الخمس</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//---------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب الأقسام
const DepartmentStatsTable: React.FC<{ stats: DepartmentStats[]; isDarkMode: boolean }> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='Departmentstatstitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب الأقسام</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//---------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب المؤسسات
const SchoolStatsTable: React.FC<{ stats: SchoolStats[]; isDarkMode: boolean }> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='Schoolstatstitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب المؤسسات</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
//---------------------------------------------------------------------------
// تحليل نتائج الشهادة حسب المديريات
const DirectoratePerformanceStatsTable: React.FC<{ stats: DirectoratePerformanceStats[]; isDarkMode: boolean }> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 id='DirectoratePerformancestatstitle' className="table-title text-xl font-semibold">تحليل نتائج الشهادة حسب المديريات</h2>
        <div className="flex gap-2">
          <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
...
export function ProgressiveDirectiveAnalysis({ data, isDarkMode }: ProgressiveDirectiveAnalysisProps) {
  ...
  const subjectStats = useSubjectStats(filteredData);
  const gradeDistribution = useGradeDistribution(filteredData);
  const genderStats = useGenderStats(filteredData);
  const repeatStats = useRepeatStats(filteredData);
  ...
  return (
    <div className={`container mx-auto px-4 py-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
      <div className="flex justify-between items-center mt-8 py-8">
        <h2 className="text-2xl font-bold mb-2">تحليل نتائج الشهادة التعليم المتوسط</h2>
          <div className="flex">
            <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
