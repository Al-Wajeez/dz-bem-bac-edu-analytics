...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("flex flex-col-2 gap-2 p-6", className)} {...props}>
    {props.children}
  </div>
))
CardContent.displayName = "CardContent"

const References = React.forwardRef<HTMLDivElement, ReferencesProps>(
  ({ className, variant, title, description, children, ...props }, ref) => {

    // Animation setup for motion
    const motionProps = {
      initial: { opacity: 0, y: 50 },  // Start with invisible and slightly down
    ...
    const PlusIcons = () => (
      <>
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-white text-red-600 size-6 absolute -top-3 -left-3"
        >
          <path
            strokeLinecap="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-white text-red-600 size-6 absolute -top-3 -right-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-white text-red-600 size-6 absolute -bottom-3 -left-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-white text-red-600 size-6 absolute -bottom-3 -right-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    const content = (
      <CardContent>
        {title && (
          <h3 className="text-ms font-bold mb-1 text-gray-800 dark:text-gray-100">
            {title}
          </h3>
        )}
        {description && (
...
export { References, CardContent, cardVariants }
...
export function DefaultCardDemo() {
  return (
    <References {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function DotsCardDemo() {
  return (
    <References variant="dots" {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function GradientCardDemo() {
  return (
    <References variant="gradient" {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function PlusCardDemo() {
  return (
    <References variant="plus" {...cardContent} className="max-w-[800px] bg-background" />
  )
}

export function NeubrutalismCardDemo() {
  return (
    <References variant="neubrutalism" {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function InnerCardDemo() {
  return (
    <References variant="inner" {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function LiftedCardDemo() {
  return (
    <References variant="lifted" {...cardContent} className="max-w-[400px] bg-background" />
  )
}

export function CornersCardDemo() {
  return (
    <References variant="corners" {...cardContent} className="max-w-[400px] bg-background" />
  )
}