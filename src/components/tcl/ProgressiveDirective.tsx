...
interface ProgressiveDirective {
  data: any[];
...
export function ProgressiveDirectiveAnalysisPage({ data, isDarkMode }: ProgressiveDirective) {
  ...
  const allFields = {
    ...
    'جانب ضبط الرغبات الأكاديمية': ['رغبة التلميذ (إستبيان الميول و الإهتمامات)  - الفصل الأول'],
    'جانب التوجيه': ['التوجيه التدريجي (ت.ت)','التوافق مع الرغبة (ت.ت)'],
  };
  ...
  const printFullInteractiveTable = () => {
    ...
    const allColumnsForPrint = [
      ...
      { key: 'معدل الفصل 1', label: 'معدل الفصل 1' },
      { key: 'رغبة التلميذ (إستبيان الميول و الإهتمامات)  - الفصل الأول', label: 'رغبة التلميذ (إستبيان الميول والإهتمامات)' },
      { key: 'شعبة آداب وفلسفة (ت.ت)', label: 'شعبة آداب وفلسفة' },
      { key: 'ترتيب التلميذ (شعبة آداب وفلسفة) (ت.ت)', label: 'ترتيب التلميذ' },
      { key: 'شعبة اللغات الأجنبية (ت.ت)', label: 'شعبة اللغات الأجنبية' },
      { key: 'ترتيب التلميذ (اللغات الأجنبية) (ت.ت)', label: 'ترتيب التلميذ (اللغات الأجنبية)' },
      { key: 'التوجيه التدريجي (ت.ت)', label: 'التوجيه التدريجي' },
      { key: 'التوافق مع الرغبة (ت.ت)', label: 'التوافق مع الرغبة' }
    ];
      ...
      <table border="0" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
          <td colspan="2" style="text-align: center; border: 2px solid #ffffff;">
            ...
            <p style="font-size: 3.5rem; font-weight: bold; margin: 1rem;">محضر التوجيه التدريجي</p><br>
  ...
  return (
      <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-bold">محضر التوجيه التدريجي | {institution}</h3>
                    ...
                    <React.Fragment key={`group-${originalIndex}`}>
                      ...
                      <tr key={originalIndex} className={`${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-100'}`}>
                        ...
                        {columnsToRender.map((column) => {
                          ...
                          if (column.key === 'التوافق مع الرغبة (ت.ت)') {
  ...
  const groupableColumns = [
    ...
    { key: 'الإعادة', label: 'الإعادة' },
    { key: 'القسم', label: 'القسم' },
    { key: 'رغبة التلميذ (إستبيان الميول و الإهتمامات)  - الفصل الأول', label: 'الرغبة' },
    { key: 'التوجيه التدريجي (ت.ت)', label: 'التوجيه التدريجي' },
    { key: 'التوافق مع الرغبة (ت.ت)', label: 'التوافق مع الرغبة' }
  ];
  ...
  const TableFilterModal = () => {
    const columns = [
      ...
      { key: 'الإعادة', label: 'الإعادة' },
      { key: 'القسم', label: 'القسم' },
      { key: 'رغبة التلميذ (إستبيان الميول و الإهتمامات)  - الفصل الأول', label: 'رغبة التلميذ (إستبيان الميول و الإهتمامات) - الفصل الأول' },
      { key: 'التوجيه التدريجي (ت.ت)', label: 'التوجيه التدريجي (ت.ت)' },
      { key: 'التوافق مع الرغبة (ت.ت)', label: 'التوافق مع الرغبة (ت.ت)' }
    ];
  ...
  return (
    <div className={`container mx-auto px-4 py-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">تحليل التوجيه التدريجي</h1>
      </div>
