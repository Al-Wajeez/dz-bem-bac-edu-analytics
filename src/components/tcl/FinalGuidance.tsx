...
export function FinalGuidanceAnalysisPage({ data, isDarkMode }: FinalGuidance) {
  ...
  const allFields = {
    ...
    'جانب ضبط الرغبات الأكاديمية': ['الرغبة النهائية للتلميذ - الفصل الثالث'],
    'جانب التوجيه': ['قرار مجلس القبول والتوجيه','التوافق مع الرغبة (ت.ن)', 'ثبات الرغبة (ت.ن)'],
  };
  ...
  const printFullInteractiveTable = () => {
    ...
    const allColumnsForPrint = [
      ...
      { key: 'المعدل السنوي', label: 'المعدل السنوي' },
      { key: 'الرغبة النهائية للتلميذ - الفصل الثالث', label: 'الرغبة النهائية للتلميذ' },
      { key: 'شعبة آداب وفلسفة (ت.ن)', label: 'شعبة آداب وفلسفة' },
      { key: 'ترتيب التلميذ (شعبة آداب وفلسفة) (ت.ن)', label: 'ترتيب التلميذ' },
      { key: 'شعبة اللغات الأجنبية (ت.ن)', label: 'شعبة اللغات الأجنبية' },
      { key: 'ترتيب التلميذ (اللغات الأجنبية) (ت.ن)', label: 'ترتيب التلميذ (اللغات الأجنبية)' },
      { key: 'قرار مجلس القبول والتوجيه', label: 'قرار مجلس القبول والتوجيه' },
      { key: 'التوافق مع الرغبة (ت.ن)', label: 'التوافق مع الرغبة' },
      { key: 'ثبات الرغبة (ت.ن)', label: 'ثبات الرغبة' }
    ];
      ...
      <table border="0" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
          <td colspan="2" style="text-align: center; border: 2px solid #ffffff;">
            ...
            <p style="font-size: 3.5rem; font-weight: bold; margin: 1rem;">محضر التوجيه النهائي</p><br>
  ...
  return (
      <div className={`mb-8 bg-white rounded-lg shadow p-6 ${isDarkMode ? 'dark-mode' : ''}`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-bold">محضر التوجيه النهائي | {institution}</h3>
                    ...
                    <React.Fragment key={`group-${originalIndex}`}>
                      ...
                      <tr key={originalIndex} className={`${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-100'}`}>
                        ...
                        {columnsToRender.map((column) => {
                          ...
                          if (column.key === 'التوافق مع الرغبة (ت.ن)') {
  ...
  const groupableColumns = [
    ...
    { key: 'الإعادة', label: 'الإعادة' },
    { key: 'القسم', label: 'القسم' },
    { key: 'الرغبة النهائية للتلميذ - الفصل الثالث', label: 'الرغبة' },
    { key: 'قرار مجلس القبول والتوجيه', label: 'قرار مجلس القبول والتوجيه' },
    { key: 'التوافق مع الرغبة (ت.ن)', label: 'التوافق مع الرغبة' },
    { key: 'ثبات الرغبة (ت.ن)', label: 'ثبات الرغبة' }
  ];
  ...
  return (
    <div className={`container mx-auto px-4 py-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">تحليل التوجيه النهائي</h1>
      </div>
