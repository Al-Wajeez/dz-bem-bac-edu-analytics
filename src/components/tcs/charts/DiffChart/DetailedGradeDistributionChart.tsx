...
interface DetailedGradeDistributionItem {
  subject: string;
...
interface DetailedGradeDistributionChartProps {
  data: DetailedGradeDistributionItem[];
  termA: string;
  termB: string;
  title: string;
  isDarkMode: boolean;
...
const DetailedGradeDistributionChart: React.FC<DetailedGradeDistributionChartProps> = ({ data, termA, termB, title, isDarkMode, onClose }) => {
